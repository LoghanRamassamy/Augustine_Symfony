...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/historique') && preg_match('#^/historique(?:/(?P<page>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'augustine_platform_history')), array (  '_controller' => 'Augustine\\PlatformBundle\\Controller\\AdvertController::historyAction',  'page' => 2,));
        }
